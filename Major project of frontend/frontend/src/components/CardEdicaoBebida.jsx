...
const CardEdicaoBebida = ({
  ...
  const atualizaBebidas = () => {
    axios
      ...
      .then((response) => {
        console.log("Updating: ", setBebidasPaginas);
        setBebidasPaginas(response.data);
      })
      .catch((erro) => {
        console.log("Everything went wrong: ", erro);
      });
  };
  ...
  const cadastrar = (e) => {
    ...
    axios
      ...
      .then((resposta) => {
        atualizaBebidas();
        alert("Drink registered successfully");
      })
  ...
  const editarBebida = (id) => {
    ...
    axios
      ...
      .then(() => {
        atualizaBebidas();
        alert("Successfully updated drink");
      })
      .catch((erro) => console.error(erro));
  };
